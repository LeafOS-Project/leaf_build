...
TELEGRAM_MESSAGE="Build $BUILD_DISPLAY_NUMBER: [See progress](${BUILD_URL}console)
Build status:"
function telegram() {
...
function ota-package-name() {
	...
	LEAF_INCR_PACKAGE="leaf-$LEAF_VERSION$LEAF_EXTRAVERSION-$OLD_BUILD_ID-incr-$BUILD_ID-$JENKINS_FLAVOR-$JENKINS_DEVICE.zip"
}
